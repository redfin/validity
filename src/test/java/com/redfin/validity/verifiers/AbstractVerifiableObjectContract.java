...
public interface AbstractVerifiableObjectContract<X extends Throwable, E, T extends AbstractVerifiableObject<E, X>>
     ...
     * @param messageSupplier          the {@link Supplier} of the String message of the verifiable object.
     *
     * @return an instance of {@link AbstractVerifiableObject}.
     */
    T getVerifiableInstance(FailedValidationExecutor<X> failedValidationExecutor,
                            E subject,
    ...
    @Test
    default void testAbstractVerifiableObjectConstructorThrowsExceptionForNullMessageSupplier() {
        NullPointerException exception = Assertions.assertThrows(NullPointerException.class,
                                                                 () -> getVerifiableInstance(getFailedValidationExecutor(), getSubject(), null));
        Assertions.assertEquals(ValidityUtils.nullArgumentMessage("messageSupplier"),
                                exception.getMessage(),
                                "Should throw an exception for a null message supplier.");
    }
    ...
    default void testGetFailedValidationExecutorReturnsGivenMessage() {
        ...
        Assertions.assertTrue(message.equals(getVerifiableInstance(getFailedValidationExecutor(), getSubject(), () -> message).getMessageSupplier().get()),
                              "An AbstractVerifiableObject should return the given message.");
    }
