...
final class VerifiablePrimitiveByteTest
 implements AbstractVerifiablePrimitiveContract<IllegalArgumentException, VerifiablePrimitiveByte<IllegalArgumentException>> {
    ...
    @Override
    public VerifiablePrimitiveByte<IllegalArgumentException> getAbstractVerifiablePrimitive(FailedValidationExecutor<IllegalArgumentException> failedValidationExecutor,
                                                                                            Supplier<String> messageSupplier) {
        return new VerifiablePrimitiveByte<>(failedValidationExecutor, (byte) 0, messageSupplier);
    }
