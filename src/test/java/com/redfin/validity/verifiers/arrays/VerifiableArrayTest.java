...
final class VerifiableArrayTest implements AbstractVerifiableObjectContract<IllegalArgumentException, String[], VerifiableArray<String, IllegalArgumentException>> {
    ...
    @Override
    public VerifiableArray<String, IllegalArgumentException> getAbstractVerifiableObjectInstance(FailedValidationExecutor<IllegalArgumentException> failedValidationExecutor, String[] subject, String message) {
        return new VerifiableArray<>(failedValidationExecutor, subject, message);
    }

    private VerifiableArray<String, IllegalArgumentException> getInstance(String[] subject) {
    ...
    void testIsEmptyReturnsSubjectForEmptySubject() {
        String[] subject = {};
        VerifiableArray<String, IllegalArgumentException> verifiable = getInstance(subject);
    ...
    void testIsEmptyThrowsForNullSubject() {
        VerifiableArray<String, IllegalArgumentException> verifiable = getInstance(null);
        Assertions.assertThrows(IllegalArgumentException.class,
                                verifiable::isEmpty);
    }
    ...
    void testHasLengthOfThrowsForSubjectWithNonMatchingLength() {
        VerifiableArray<String, IllegalArgumentException> verifiable = getInstance(new String[]{"hello", "world"});
        Assertions.assertThrows(IllegalArgumentException.class,
    ...
    void testHasLengthOfAtLeastThrowsForSubjectWithNonMatchingLength() {
        VerifiableArray<String, IllegalArgumentException> verifiable = getInstance(new String[]{});
        Assertions.assertThrows(IllegalArgumentException.class,
    ...
    void testHasLengthOfAtMosthrowsForSubjectWithNonMatchingLength() {
        VerifiableArray<String, IllegalArgumentException> verifiable = getInstance(new String[]{"hello"});
        Assertions.assertThrows(IllegalArgumentException.class,
